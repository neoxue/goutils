...
func TestLocalhost(t *testing.T) {
	...
	testWithClient(t, NewMemcachedProxy(testServer))
}
...
func mustSetF(t *testing.T, c *Proxy) func(*memcache.Item) {
...
func testWithClient(t *testing.T, c *Proxy) {
...
func testTouchWithClient(t *testing.T, c *Proxy) {
	if testing.Short() {
...
func BenchmarkOnItem(b *testing.B) {
	...
	c := NewMemcachedProxy(addr.String())
